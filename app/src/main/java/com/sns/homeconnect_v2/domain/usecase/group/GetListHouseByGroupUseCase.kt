...
class GetListHouseByGroupUseCase @Inject constructor(
    private val groupRepository: GroupRepository
) {
    suspend operator fun invoke(groupId: Int): Result<List<House>> {
        return groupRepository.getListHouseByGroup(groupId)
    }
}