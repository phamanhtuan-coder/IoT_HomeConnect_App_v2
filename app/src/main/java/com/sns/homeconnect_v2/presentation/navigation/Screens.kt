...
//    }
    ...
    data object SpaceDetail : Screens("space_detail/{spaceId}/{currentUserRole}") {
        fun createRoute(spaceId: Int, currentUserRole: String) = "space_detail/$spaceId/$currentUserRole"
    }
